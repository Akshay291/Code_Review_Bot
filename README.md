...
Experience the complete workflow of the **AI Code Review Assistant**—from connecting your Groq API key to receiving a detailed AI-powered code review with conversation memory.
...
The landing page allows users to paste source code, select a programming language, choose a review mode, and securely connect their Groq API key.

---

## ⚡ Review & Quick Follow-up Questions

<p align="center">
    <img src="screenshots/review_history.png" width="100%">
</p>

Generate an AI-powered code review and continue the discussion using built-in follow-up prompts such as time complexity, unit testing, design patterns, memory usage, and error handling.
...
<p align="center">
    <img src="screenshots/review_summary.png" width="100%">
</p>

Receive a structured review generated by the LLM covering:
...
## 📚 Refactored Code & Learning Resources

<p align="center">
    <img src="screenshots/recommendations.png" width="100%">
</p>

Every review concludes with an improved implementation, explanations of the suggested changes, and curated learning resources to help developers improve their coding skills.
...
<p align="center">
    <img src="screenshots/deploy_home.png" width="100%">
</p>

The application is deployed on **Streamlit Cloud**, making it accessible directly from the browser without requiring local installation.

---

## 💬 Review History & Conversation Memory

<p align="center">
    <img src="screenshots/deploy_history.png" width="100%">
</p>

The assistant preserves conversation history using LangChain message memory, allowing users to ask follow-up questions while maintaining the full context of previous reviews.
